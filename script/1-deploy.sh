...
command="forge create $VERIFY_FLAGS --rpc-url $EVM_RPC --private-key $EVM_PRIVATE_KEY src/SedaProver.sol:SedaProver --constructor-args $EVM_ADMIN_ADDRESS [$EVM_ADMIN_ADDRESS] 1"
output=$($command)
